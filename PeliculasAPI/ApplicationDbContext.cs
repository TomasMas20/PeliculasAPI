...
namespace PeliculasAPI
{
    public class ApplicationDbContext : DbContext
    {
        ...
        private void SeedData(ModelBuilder modelBuilder)
        {
            ...
            var jimCarrey = new Actor() { Id = 5, Nombre = "Jim Carrey", FechaDeNacimiento = new DateTime(1962, 01, 17) };
            var robertDowney = new Actor() { Id = 6, Nombre = "Robert Downey Jr.", FechaDeNacimiento = new DateTime(1965, 4, 4) };
            var chrisEvans = new Actor() { Id = 7, Nombre = "Chris Evans", FechaDeNacimiento = new DateTime(1981, 06, 13) };
        ...
        public DbSet<PeliculasActores> PeliculasAcotres { get; set; }
