    ...
    public partial class PeliculasActores_PeliculasGeneros : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PeliculasAcotres", x => new { x.ActorId, x.PeliculaId });
                    table.ForeignKey(
                        name: "FK_PeliculasAcotres_Actores_ActorId",
                        column: x => x.ActorId,
                        principalTable: "Actores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PeliculasAcotres_Peliculas_PeliculaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PeliculasAcotres_PeliculaId",
                table: "PeliculasAcotres",
                column: "PeliculaId");
